...
export const CartProvider = ({ children }) => {
  ...
  // AJOUTER : On injecte le userId dans l'objet produit
  const addToCart = (product, quantity) => {
    ...
    setCart((prevCart) => {
      ...
      // On enregistre le produit avec la clé userId
  ...
  const clearCart = () => {
    // On ne vide que les articles de l'utilisateur actuel
    setCart(cart.filter((item) => item.userId !== userId));
  };

  // FILTRE CRITIQUE : Seuls les articles de l'utilisateur actuel sont comptés
